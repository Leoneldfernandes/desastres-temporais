...
- `data/atlas-summary.json`: resumo mensal usado pelo mapa, KPIs e tabela;
- `data/geo/municipios-br.geojson`: malha simplificada dos 5.573 municípios, carregada na abertura;
- `data/geo/uf/*.json`: malhas estaduais mais detalhadas, carregadas somente ao escolher uma UF;
- `data/events/*.json`: registros completos separados por UF, carregados somente ao clicar em um município.

Na primeira abertura, o navegador transfere aproximadamente 3,3 MB com compressão HTTP. Os detalhes são baixados sob demanda e ficam no cache normal do navegador. Assim, o Brasil inteiro é viável no GitHub Pages sem servidor, banco de dados ou Google Drive.
